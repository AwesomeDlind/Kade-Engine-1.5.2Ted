...
class FreeplayState extends MusicBeatState
{
	...
	{
	if (PlayState.normalFreeplay == true)
	{
		...
		{
		var initSonglist = CoolUtil.coolTextFile(Paths.txt('bonusSongs'));
		 ...
		 */
		 ...
		 #if windows
		 // Updating Discord Rich Presence
		 DiscordClient.changePresence("In the Bonus Songs Menu", null);
		 #end
