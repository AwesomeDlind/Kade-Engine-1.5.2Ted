...
class Ratings
{
    public static function GenerateLetterRank(accuracy:Float) // generate a letter ranking
    {
        ...
        if (PlayState.misses == 0 && PlayState.bads == 0 && PlayState.shits == 0 && PlayState.goods == 0 && PlayState.comboBreaks == 0) // Marvelous (SICK) Full Combo
            ranking = "(MFC)";
        else if (PlayState.misses == 0 && PlayState.bads == 0 && PlayState.shits == 0 && PlayState.goods >= 1 && PlayState.comboBreaks == 0) // Good Full Combo (Nothing but Goods & Sicks)
            ranking = "(GFC)";
        else if (PlayState.misses == 0 && PlayState.comboBreaks == 0) // Regular FC
            ranking = "(FC)";
        else if (PlayState.misses == 0 && PlayState.comboBreaks < 10) // Single Digit Combo Breaks
            ranking = "(SDCB)";
        else if (PlayState.misses < 10 && PlayState.comboBreaks == 0) // Single Digit Misses
            ranking = "(SDM)";
    ...
    public static function CalculateRanking(score:Int,scoreDef:Int,nps:Int,maxNPS:Int,accuracy:Float):String
    {
        ...
        " | Missed:" + PlayState.misses + 																				        // Misses
